...
if __name__ == '__main__':
    ...
    classalgs = {'Linear Regression': algs.LinearRegressionClass(),
                 ...
                 'Third regularizer Logistic Regression': algs.LogitReg({'regularizer': 'other'}),
    ...
    for r in range(numruns):
        ...
        #print(trainset[0].shape[0], "  ", testset[0].shape[0], " ", r);
        
        print('Running on train={0} and test={1} samples for run {2}'.format(int(trainset[0].shape[0]), int(testset[0].shape[0]), int(r)))
